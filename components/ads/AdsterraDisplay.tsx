...
export function AdsterraDisplay() {
  ...
  useEffect(() => {
    ...
    opt.textContent = `atOptions = { 'key': '8b8257a014c8930d307728c3dd3b9bc3', 'format': 'iframe', 'height': 90, 'width': 728, 'params': {} };`;
    ref.current.appendChild(opt);
    const invoke = document.createElement('script');
    invoke.src = 'https://www.highperformanceformat.com/8b8257a014c8930d307728c3dd3b9bc3/invoke.js';
